...
rem ## 
rem ##
rem ## Copyright (c) 2001-2015 by TIBCO Software Inc.
rem ## ALL RIGHTS RESERVED
rem ##
rem ## $Id: setup.bat 83129 2015-11-19 22:38:01Z $
rem ##
...
if NOT EXIST %TIBEMS_JAVA%\slf4j-api-1.5.2.jar goto badenv
if NOT EXIST %TIBEMS_JAVA%\slf4j-simple-1.5.2.jar goto badenv

set CLASSPATH=%TIBEMS_JAVA%\jms-2.0.jar;%CLASSPATH%
set CLASSPATH=.;%TIBEMS_JAVA%\tibjms.jar;%TIBEMS_JAVA%\tibjmsufo.jar;%TIBEMS_JAVA%\tibcrypt.jar;%TIBEMS_JAVA%\tibjmsadmin.jar;%TIBEMS_JAVA%\slf4j-api-1.5.2.jar;%TIBEMS_JAVA%\slf4j-simple-1.5.2.jar;%CLASSPATH%
