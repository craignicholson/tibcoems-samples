 ...
 *       makecert -pe -ss my -sr CurrentUser -a sha1 -sky exchange -in "SampleAuthority" -is My -ir CurrentUser -sp "Microsoft RSA Schannel Cryptographic Provider" -sy 12 -n "CN=client-sample-cert" -b 1/1/2016 -e 01/01/2999 -eku 1.3.6.1.5.5.7.3.2 Client.cer
 * 
