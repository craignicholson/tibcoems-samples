...
set CLASSPATH=.;%TIBEMS_JAVA%\tibjms.jar;%TIBEMS_JAVA%\tibcrypt.jar;%TIBEMS_JAVA%\tibjmsadmin.jar;%TIBEMS_JAVA%\slf4j-api-1.5.2.jar;%TIBEMS_JAVA%\slf4j-simple-1.5.2.jar;%CLASSPATH%
